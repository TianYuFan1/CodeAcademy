...
transactions_clean = [[] for transaction in range(len(daily_transactions_split))]

for i in range(len(daily_transactions_split)):
    transaction = daily_transactions_split[i]
    for item in transaction:
        transactions_clean[i].append(item.strip())
...
for color in colors:
    print("There are {COLOR_COUNT} {COLOR} sold".format(COLOR_COUNT = color_count(color), COLOR = color))